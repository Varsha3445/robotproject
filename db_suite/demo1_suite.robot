...
TC3
    Execute Sql String    Insert into Products (product_id,productname,description) values (651,'Varsha','just name')
...
TC5
    Execute Sql String    update Products set productname='varsha' where product_id=651
